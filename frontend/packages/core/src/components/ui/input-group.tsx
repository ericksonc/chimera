...
import { Textarea } from "@chimera/core/components/ui/textarea"

/**
 * Renders a grouped input container with `data-slot="input-group"` and `role="group"` that applies variant-aware styling and forwards any div props.
 *
 * @returns A `div` element used as the input group container with `data-slot="input-group"` and `role="group"`.
 */
