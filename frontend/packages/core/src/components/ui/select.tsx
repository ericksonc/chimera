...
/**
 * Renders a styled trigger for the Select component with optional size variants.
 *
 * Merges provided className with the component's base styles, applies a data-size attribute,
 * and renders a trailing chevron icon.
 *
 * @param className - Additional CSS classes to merge with the default trigger styles.
 * @param size - Visual size variant for the trigger; `"default"` for standard height, `"sm"` for a more compact height.
