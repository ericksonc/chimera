...
from core.threadprotocol.blueprint import InlineAgentConfig


def test_agent_from_yaml():
    """Test loading agent from YAML file."""
    yaml_path = "tests/fixtures/agents/jarvis.yaml"
...
def test_agent_round_trip_serialization():
    ...
    assert "You are Jarvis" in config_dict["base_prompt"]
